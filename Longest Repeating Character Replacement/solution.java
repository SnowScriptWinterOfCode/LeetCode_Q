...
// basic concept is that aslong k is not zero we can count and accomodate other string as we can change them
// when k becomes 0 we can no longer add different string to the window      
